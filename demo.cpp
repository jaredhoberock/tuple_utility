...
int main()
{
  ...
  std::cout << "negative_t: ";
  tuple_print(std::cout, negative_t);
  std::cout << std::endl;
  ...
  tuple_print(std::cout, six_t_first_two);
  std::cout << std::endl;
